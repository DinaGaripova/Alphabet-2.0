...
public class Letters : MonoBehaviour
{
    ...
    private Game letTest;
    [SerializeField] private GameObject m_gameObject;

    protected virtual void Start()
    {
        letTest = m_gameObject.GetComponent<Game>();
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        if (letTest.letter == mTrackableBehaviour.TrackableName)
        {
            Debug.Log("ok");
            letTest.Right();
        }
        else if(letTest.letter != mTrackableBehaviour.TrackableName)
        {
            Debug.Log("no");
            letTest.Wrong();
        }
